...
"use strict";var tourClick=document.querySelector(".tour__click"),tourFreeDate=document.querySelector(".tour__free-date");tourClick.addEventListener("click",(function(){tourFreeDate.classList.toggle("dates-free")}));var tourClickPeople=document.querySelector(".tour__click-people"),tourPeopleBlock=document.querySelector(".tour__people-block");tourClickPeople.addEventListener("click",(function(){tourPeopleBlock.classList.toggle("people-click")}));var tourClickOptions=document.querySelector(".tour__click-options"),tourOptionsBlock=document.querySelector(".tour__options-block");tourClickOptions.addEventListener("click",(function(){tourOptionsBlock.classList.toggle("click-options")}));
