...
"use strict";var bookingDateBtn=document.querySelector(".booking__date-btn"),bookingFormdate=document.querySelector(".booking__form-date"),bookingFormdateBtn=document.querySelector(".booking__form-date-btn");console.log(bookingFormdateBtn),bookingDateBtn.addEventListener("click",(function(){bookingFormdate.classList.toggle("form-active"),console.log(55)})),bookingFormdateBtn.addEventListener("click",(function(){bookingFormdate.classList.toggle("form-active")}));var bookingPeopleBtn=document.querySelector(".booking__people-btn"),bookingFormnum=document.querySelector(".booking__formnum");console.log(bookingFormnum),bookingPeopleBtn.addEventListener("click",(function(){bookingFormnum.classList.toggle("formnum-active")}));var bookingOptionsbtn=document.querySelector(".booking__options-btn"),bookingFormoption=document.querySelector(".booking__formoption"),bookingFormoptionBtn=document.querySelector(".booking__formoption-btn");console.log(bookingFormoption),console.log(bookingFormoptionBtn),console.log(bookingOptionsbtn),bookingOptionsbtn.addEventListener("click",(function(){bookingFormoption.classList.toggle("opt-active")})),bookingFormoptionBtn.addEventListener("click",(function(){bookingFormoption.classList.toggle("opt-active")}));var form=function(){var o=document.querySelector(".booking__form"),n=$(".booking__title");$(".booking__form").submit((function(t){t.preventDefault(),$.ajax({url:"https://jsonplaceholder.typicode.com/todos",type:"POST",data:$(this).serialize(),success:function(t){n.text("Спасибо ваша заявка принята, номер заявки "+t.id),o.reset()},error:function(){n.text("Что то пошло не так, попробуйте позже!")}})}))};form();var mask=function(){var o=document.querySelector(".booking__phone-input");new Inputmask("+7 (999)-999-99-99").mask(o)};mask();
"use strict";var burgerBtn=document.querySelector(".header__burger"),burgerNav=document.querySelector(".header__navigator");burgerBtn.addEventListener("click",(function(){burgerNav.classList.toggle("header__burger-toggle")}));
...
"use strict";var safari=function(){document.addEventListener("click",(function(t){t.target.matches("button")&&t.target.focus()}))};safari();var scroll=function(){var t=$("html, body");$('a[href*="#"]').click((function(){return t.animate({scrollTop:$($.attr(this,"href")).offset().top},500),!1}))};scroll();
