...
"use strict";var characteristicsListElem=document.querySelector(".info__list"),characteristicsItemElems=document.querySelectorAll(".info__item");characteristicsItemElems.forEach((function(e){setTimeout((function(){e.children[1].classList.contains("active")&&(e.children[1].style.height=e.children[1].scrollHeight+"px")}),500)}));var open=function(e,t){closeAllDrops(e,t),e.ariaExpanded=!0,t.style.height=t.scrollHeight+"px",e.classList.add("active"),t.classList.add("active")},close=function(e,t){e.ariaExpanded=!1,e.classList.remove("active"),t.classList.remove("active"),t.style.height=""},closeAllDrops=function(e,t){characteristicsItemElems.forEach((function(c){c.children[0]!==e&&c.children[1]!==t&&close(c.children[0],c.children[1])}))};characteristicsListElem.addEventListener("click",(function(e){var t=e.target;if(t.classList.contains("info__button")){var c=t.closest(".info__item").querySelector(".info__text");c.classList.contains("active")?close(t,c):open(t,c)}}));
"use strict";var bookingDateBtn=document.querySelector(".booking__date-btn"),bookingFormdate=document.querySelector(".booking__form-date"),bookingFormdateBtn=document.querySelector(".booking__form-date-btn");console.log(bookingFormdateBtn),bookingDateBtn.addEventListener("click",(function(){bookingFormdate.classList.toggle("form-active")})),bookingFormdateBtn.addEventListener("click",(function(){bookingFormdate.classList.toggle("form-active")}));var bookingPeopleBtn=document.querySelector(".booking__people-btn"),bookingFormnum=document.querySelector(".booking__formnum");bookingPeopleBtn.addEventListener("click",(function(){bookingFormnum.classList.toggle("formnum-active")}));var bookingOptionsbtn=document.querySelector(".booking__options-btn"),bookingFormoption=document.querySelector(".booking__formoption"),bookingFormoptionBtn=document.querySelector(".booking__formoption-btn");bookingOptionsbtn.addEventListener("click",(function(){bookingFormoption.classList.toggle("opt-active")})),bookingFormoptionBtn.addEventListener("click",(function(){bookingFormoption.classList.toggle("opt-active")}));var form=function(){var o=document.querySelector(".booking__form"),t=$(".booking__title");$(".booking__form").submit((function(n){n.preventDefault(),$.ajax({url:"https://jsonplaceholder.typicode.com/todos",type:"POST",data:$(this).serialize(),success:function(n){t.text("Спасибо ваша заявка принята, номер заявки "+n.id),o.reset()},error:function(){t.text("Что то пошло не так, попробуйте позже!")}})}))};form();var mask=function(){var o=document.querySelector(".booking__phone-input");new Inputmask("+7 (999)-999-99-99").mask(o)};mask();
"use strict";var burgerBtn=document.querySelector(".header__burger"),burgerNav=document.querySelector(".header__navigator"),navBurger=$(".header__navigator"),footerMenuLink=document.querySelector(".header__link");console.log(footerMenuLink),burgerBtn.addEventListener("click",(function(){burgerNav.classList.toggle("header__burger-toggle"),footerMenuLink.style.display="none"}));
"use strict";var swiper=new Swiper(".photo__swiper",{loop:!0,slidesPerView:1,spaceBetween:0,centeredSlides:!0,centeredSlidesBounds:!0,mousewheel:!0,keyboard:!0,navigation:{nextEl:".photo__btn-right",prevEl:".photo__btn-left"}});
"use strict";var safari=function(){document.addEventListener("click",(function(o){o.target.matches("button")&&o.target.focus()}))};safari();var scroll=function(){var o=$("html, body");$('a[href*="#"]').click((function(){return o.animate({scrollTop:$($.attr(this,"href")).offset().top},500),!1}))};scroll();var footerForm=function(){document.querySelector(".footer__form-input");var o=document.querySelector(".footer__form");$(".footer__form").submit((function(t){t.preventDefault(),$.ajax({url:"https://jsonplaceholder.typicode.com/todos",type:"POST",data:$(this).serialize(),success:function(t){console.log("Заявка успешно отправлена!!!"),o.reset()},error:function(){console.log("Что то пошло не так, попробуйте позже!")}})}))};footerForm();
"use strict";var instalClassSwiper=function(){new Swiper(".present-swiper",{slidesPerView:1,centeredSlides:!0,centeredSlidesBounds:!0,pagination:{el:".swiper-pagination"},mousewheel:!0,keyboard:!0,breakpoints:{730:{slidesPerView:1,centeredSlides:!0,centeredSlidesBounds:!0},320:{slidesPerView:1,centeredSlides:!0,centeredSlidesBounds:!0}}})};window.addEventListener("DOMContentLoaded",(function(){window.screen.width<=730&&(instalClassSwiper(document.querySelector(".present-swiper")),document.querySelector(".present-swiper").closest(".swiper")||location.reload())})),window.addEventListener("resize",(function(){window.screen.width>730&&document.querySelector(".present-swiper").closest(".swiper")&&location.reload(),window.screen.width<=730&&(instalClassSwiper(document.querySelector(".present-swiper")),document.querySelector(".present-swiper").closest(".swiper")||location.reload())}));
"use strict";var tourClick=document.querySelector(".tour__click"),tourFreeDate=document.querySelector(".tour__free-date");tourClick.addEventListener("click",(function(){tourFreeDate.classList.toggle("dates-free")}));var tourClickPeople=document.querySelector(".tour__click-people"),tourPeopleBlock=document.querySelector(".tour__people-block");tourClickPeople.addEventListener("click",(function(){tourPeopleBlock.classList.toggle("people-click")}));var tourClickOptions=document.querySelector(".tour__click-options"),tourOptionsBlock=document.querySelector(".tour__options-block");tourClickOptions.addEventListener("click",(function(){tourOptionsBlock.classList.toggle("click-options")}));var tourDateBtn=document.querySelector(".tour__date-btn");tourDateBtn.addEventListener("click",(function(){tourFreeDate.classList.toggle("dates-free")}));var tourDateBtnClick=document.querySelector(".tour__date-btn-click");console.log(tourDateBtnClick),tourDateBtnClick.addEventListener("click",(function(){tourOptionsBlock.classList.toggle("click-options")}));
